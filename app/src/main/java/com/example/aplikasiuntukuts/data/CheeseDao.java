...
import static com.example.aplikasiuntukuts.data.Cheese.COLUMN_NAME;
...
public interface CheeseDao {
    ...
    @Query("SELECT * FROM " + Cheese.TABLE_NAME + " ORDER BY " + COLUMN_NAME+ " ASC" )
    LiveData<List<Cheese>> getAllCheeses (); //Tambahan untuk menjadikannya LIVE DATA
    /**
